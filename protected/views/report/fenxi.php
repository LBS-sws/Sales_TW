    ...
    <div class="box box-info">
        <div class="box-body">
            ...
            <div>
                ...
                <table class="tftable1" border="1">
                    <tr><th rowspan="2" width="100">拜访目的</th><th >新開發</th><td ><?php echo $arr['shouci'];?></td><th >客诉</th><td ><?php echo $arr['keshu'];?></td><th >续约</th><td ><?php echo $arr['xuyue'];?></td><th  >開發中客戶覆訪</th><td ><?php echo $arr['huifang'];?></td><th  >报价</th><td ><?php echo $arr['baojia'];?></td><th  >追款</th><td ><?php echo $arr['zuikuan'];?></td><th  >减价</th><td ><?php echo $arr['jianjia'];?></td></tr>
                    <tr><th>停服务</th><td><?php echo $arr['tingfuwu'];?></td><th>更换项目</th><td><?php echo $arr['genghuanxiangmu'];?></td><th>增加项目</th><td><?php echo $arr['zengjiaxiangmu'];?></td><th>停單客戶回訪</th><td><?php echo $arr['jiuke'];?></td><th>其他</th><td><?php echo $arr['qitaa'];?></td><th>签单</th><td><?php echo $arr['qiandan'];?></td></tr>
                </table>
                <table class="tftable2" border="1">
                ...
                <table class="tftable3" border="1">
                    <tr><th rowspan="3" width="100">客服类别（餐饮）</th><th >PUB</th><td ><?php echo $arr['dongbeicai'];?></td><th >日式</th><td ><?php echo $arr['taiguocai'];?></td><th >粤菜</th><td ><?php echo $arr['yuecai'];?></td><th >蛋糕/麵包/甜點</th><td ><?php echo $arr['mianbao'];?></td><th >婚宴會館</th><td ><?php echo $arr['chuancai'];?></td><th >火鍋</th><td ><?php echo $arr['huoguo'];?></td><th >西餐</th><td ><?php echo $arr['xican'];?></td></tr>
                    <tr><th>中餐</th><td><?php echo $arr['kafeiting'];?></td><th>早餐</th><td><?php echo $arr['zejiangcai'];?></td><th>自助餐</th><td><?php echo $arr['zizhu'];?></td><th>饮品店</th><td><?php echo $arr['yingping'];?></td><th>廠房餐廳</th><td><?php echo $arr['riliao'];?></td><th>燒烤/炸物</th><td><?php echo $arr['saokao'];?></td><th>飲料店</th><td><?php echo $arr['yuenancai'];?></td></tr>
                    <tr><th>咖啡餐廳</th><td><?php echo $arr['xiaochi'];?></td><th>異國料理</th><td><?php echo $arr['qingzhencai'];?></td><th>茶餐厅</th><td><?php echo $arr['chacanting'];?></td><th>其他</th><td><?php echo $arr['qitab'];?></td></tr>
                    <tr><th rowspan="5" width="100">客服类别（非餐饮）</th><th>4S店</th><td><?php echo $arr['sisdian'];?></td><th>健身会所</th><td><?php echo $arr['jianshenhuisuo'];?></td><th>旅館業</th><td><?php echo $arr['fangdican'];?></td><th>美容/发馆</th><td><?php echo $arr['meifa'];?></td><th >银行</th ><td><?php echo $arr['yinhang'];?></td><th >俱乐部</th><td><?php echo $arr['julebu'];?></td><th >加油站</th><td><?php echo $arr['peixunjigou'];?></td> </tr>
                    <tr><th>KTV</th><td><?php echo $arr['ktv'];?></td><th>其他</th><td><?php echo $arr['qitac'];?></td><th>商辦</th><td><?php echo $arr['xuexiao'];?></td><th>營造</th><td><?php echo $arr['shuiliao'];?></td><th>超市</th><td><?php echo $arr['chaoshi'];?></td><th >网吧</th><td><?php echo $arr['wangba'];?></td><th >教育業</th><td><?php echo $arr['yingyuan'];?></td></tr>
                    <tr><th>体育馆</th><td><?php echo $arr['tiyuguan'];?></td><th>休閒娛樂</th><td><?php echo $arr['xiezilou'];?></td><th>工廠</th><td><?php echo $arr['gongcang'];?></td><th>補教</th><td><?php echo $arr['youyong'];?></td><th>酒吧</th><td><?php echo $arr['jiuba'];?></td><th>醫療</th><td><?php echo $arr['wuye'];?></td><th>酒店</th><td><?php echo $arr['jiudian'];?></td></tr>
                    <tr><th>便利店</th><td><?php echo $arr['bianlidian'];?></td><th>公家機關</th><td><?php echo $arr['yiyuan'];?></td><th>家居/社區</th><td><?php echo $arr['yinglou'];?></td><th>政府及企事业单位</th><td><?php echo $arr['zhengfu'];?></td></tr>
                </table>
            </div>
            <?php } } ?>
        </div>
