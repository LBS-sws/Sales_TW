...
//        print_r($records);
        ...
        $jiudian=0;
        $zhengfu=0;
        $arr['mobai']=$this->shul($mobai,$records,'visit_type_name','陌生開發');
        $arr['richanggengjin']=$this->shul($richanggengjin,$records,'visit_type_name','日常跟進');
        $arr['kehuziyuan']=$this->shul($kehuziyuan,$records,'visit_type_name','客戶資源');
        $arr['dianhuashangmen']=$this->shul($dianhuashangmen,$records,'visit_type_name','電話上門');
        $arr['shouci']=$this->shul($shouci,$records,'visit_obj_name','新開發');
        $arr['huifang']=$this->shul($huifang,$records,'visit_obj_name','開發中客戶覆訪');
        ...
        $arr['jiuke']=$this->shul($jiuke,$records,'visit_obj_name','停單客戶回訪');
        ...
        $arr['dongbeicai']=$this->shul($dongbeicai,$records,'cust_type_name','PUB');
        $arr['kafeiting']=$this->shul($kefeiting,$records,'cust_type_name','中餐');
        $arr['xiaochi']=$this->shul($xiaochi,$records,'cust_type_name','咖啡餐廳');
        $arr['chuancai']=$this->shul($chuancai,$records,'cust_type_name','婚宴會館');
        $arr['riliao']=$this->shul($riliao,$records,'cust_type_name','廠房餐廳');
        $arr['taiguocai']=$this->shul($taiguocai,$records,'cust_type_name','日式');
        $arr['zejiangcai']=$this->shul($zejiangcai,$records,'cust_type_name','早餐');
        $arr['qingzhencai']=$this->shul($qingzhencai,$records,'cust_type_name','異國料理');
        $arr['huoguo']=$this->shul($huoguo,$records,'cust_type_name','火锅');
        $arr['saokao']=$this->shul($shaokao,$records,'cust_type_name','燒烤/炸物');
        ...
        $arr['yuenancai']=$this->shul($yuenancai,$records,'cust_type_name','飲料店');
        $arr['mianbao']=$this->shul($mianbao,$records,'cust_type_name','蛋糕/麵包/甜點');
        ...
        $arr['xiezilou']=$this->shul($xiezilou,$records,'cust_type_name','休閒娛樂');
        $arr['yiyuan']=$this->shul($yiyuan,$records,'cust_type_name','公家機關');
        $arr['peixunjigou']=$this->shul($peixunjigou,$records,'cust_type_name','加油站');
        $arr['xuexiao']=$this->shul($xuexiao,$records,'cust_type_name','商辦');
        $arr['gongcang']=$this->shul($gongcang,$records,'cust_type_name','工廠');
        $arr['yinglou']=$this->shul($yinglou,$records,'cust_type_name','家居/社區');
        $arr['yingyuan']=$this->shul($yingyuan,$records,'cust_type_name','教育業');
        $arr['fangdican']=$this->shul($fangdican,$records,'cust_type_name','旅館業');
        $arr['shuiliao']=$this->shul($shuiliao,$records,'cust_type_name','營造');
        $arr['youyong']=$this->shul($youyong,$records,'cust_type_name','補教');
        $arr['wuye']=$this->shul($wuye,$records,'cust_type_name','醫療');
    ...
    public function fenxione($model){
        ...
        if(empty($recity)){
            foreach ($model['sale'] as $v) {
                ...
                $arr['mobai']=$this->shul($a,$records,'visit_type_name','陌生開發');
                $arr['richanggengjin']=$this->shul($a,$records,'visit_type_name','日常跟進');
                $arr['kehuziyuan']=$this->shul($a,$records,'visit_type_name','客戶資源');
                $arr['dianhuashangmen']=$this->shul($a,$records,'visit_type_name','電話上門');
                $arr['shouci']=$this->shul($a,$records,'visit_obj_name','新開發');
                $arr['huifang']=$this->shul($a,$records,'visit_obj_name','開發中客戶覆訪');
                ...
                $arr['jiuke']=$this->shul($a,$records,'visit_obj_name','停單客戶回訪');
                ...
                $arr['dongbeicai']=$this->shul($a,$records,'cust_type_name','PUB');
                $arr['kafeiting']=$this->shul($a,$records,'cust_type_name','中餐');
                $arr['xiaochi']=$this->shul($a,$records,'cust_type_name','咖啡餐廳');
                $arr['chuancai']=$this->shul($a,$records,'cust_type_name','婚宴會館');
                $arr['riliao']=$this->shul($a,$records,'cust_type_name','廠房餐廳');
                $arr['taiguocai']=$this->shul($a,$records,'cust_type_name','日式');
                $arr['zejiangcai']=$this->shul($a,$records,'cust_type_name','早餐');
                $arr['qingzhencai']=$this->shul($a,$records,'cust_type_name','異國料理');
                $arr['huoguo']=$this->shul($a,$records,'cust_type_name','火锅');
                $arr['saokao']=$this->shul($a,$records,'cust_type_name','燒烤/炸物');
                ...
                $arr['yuenancai']=$this->shul($a,$records,'cust_type_name','飲料店');
                $arr['mianbao']=$this->shul($a,$records,'cust_type_name','蛋糕/麵包/甜點');
                ...
                $arr['xiezilou']=$this->shul($a,$records,'cust_type_name','休閒娛樂');
                $arr['yiyuan']=$this->shul($a,$records,'cust_type_name','公家機關');
                $arr['peixunjigou']=$this->shul($a,$records,'cust_type_name','加油站');
                $arr['xuexiao']=$this->shul($a,$records,'cust_type_name','商辦');
                $arr['gongcang']=$this->shul($a,$records,'cust_type_name','工廠');
                $arr['yinglou']=$this->shul($a,$records,'cust_type_name','家居/社區');
                $arr['yingyuan']=$this->shul($a,$records,'cust_type_name','教育業');
                $arr['fangdican']=$this->shul($a,$records,'cust_type_name','旅館業');
                $arr['shuiliao']=$this->shul($a,$records,'cust_type_name','營造');
                $arr['youyong']=$this->shul($a,$records,'cust_type_name','補教');
                $arr['wuye']=$this->shul($a,$records,'cust_type_name','醫療');
...
//        print_r('<pre/>');
    ...
    public function fenxis($model){
        ...
        $jiudian=0;
        $zhengfu=0;
        $arr['mobai']=$this->shuls($mobai,$records,'visit_type_name','陌生開發');
        $arr['richanggengjin']=$this->shuls($richanggengjin,$records,'visit_type_name','日常跟進');
        $arr['kehuziyuan']=$this->shuls($kehuziyuan,$records,'visit_type_name','客戶資源');
        $arr['dianhuashangmen']=$this->shuls($dianhuashangmen,$records,'visit_type_name','電話上門');
        $arr['shouci']=$this->shuls($shouci,$records,'visit_obj_name','新開發');
        $arr['huifang']=$this->shuls($huifang,$records,'visit_obj_name','開發中客戶覆訪');
        ...
        $arr['jiuke']=$this->shuls($jiuke,$records,'visit_obj_name','停單客戶回訪');
        ...
        $arr['dongbeicai']=$this->shuls($dongbeicai,$records,'cust_type_name','PUB');
        $arr['kafeiting']=$this->shuls($kefeiting,$records,'cust_type_name','中餐');
        $arr['xiaochi']=$this->shuls($xiaochi,$records,'cust_type_name','咖啡餐廳');
        $arr['chuancai']=$this->shuls($chuancai,$records,'cust_type_name','婚宴會館');
        $arr['riliao']=$this->shuls($riliao,$records,'cust_type_name','廠房餐廳');
        $arr['taiguocai']=$this->shuls($taiguocai,$records,'cust_type_name','日式');
        $arr['zejiangcai']=$this->shuls($zejiangcai,$records,'cust_type_name','早餐');
        $arr['qingzhencai']=$this->shuls($qingzhencai,$records,'cust_type_name','異國料理');
        $arr['huoguo']=$this->shuls($huoguo,$records,'cust_type_name','火锅');
        $arr['saokao']=$this->shuls($shaokao,$records,'cust_type_name','燒烤/炸物');
        ...
        $arr['yuenancai']=$this->shuls($yuenancai,$records,'cust_type_name','飲料店');
        $arr['mianbao']=$this->shuls($mianbao,$records,'cust_type_name','蛋糕/麵包/甜點');
        ...
        $arr['xiezilou']=$this->shuls($xiezilou,$records,'cust_type_name','休閒娛樂');
        $arr['yiyuan']=$this->shuls($yiyuan,$records,'cust_type_name','公家機關');
        $arr['peixunjigou']=$this->shuls($peixunjigou,$records,'cust_type_name','加油站');
        $arr['xuexiao']=$this->shuls($xuexiao,$records,'cust_type_name','商辦');
        $arr['gongcang']=$this->shuls($gongcang,$records,'cust_type_name','工廠');
        $arr['yinglou']=$this->shuls($yinglou,$records,'cust_type_name','家居/社區');
        $arr['yingyuan']=$this->shuls($yingyuan,$records,'cust_type_name','教育業');
        $arr['fangdican']=$this->shuls($fangdican,$records,'cust_type_name','旅館業');
        $arr['shuiliao']=$this->shuls($shuiliao,$records,'cust_type_name','營造');
        $arr['youyong']=$this->shuls($youyong,$records,'cust_type_name','補教');
        $arr['wuye']=$this->shuls($wuye,$records,'cust_type_name','醫療');
    ...
    public function fenxiones($model){
        ...
        if(empty($recity)){
            foreach ($model['sale'] as $v) {
                ...
                $arr['mobai']=$this->shuls($a,$records,'visit_type_name','陌生開發');
                $arr['richanggengjin']=$this->shuls($a,$records,'visit_type_name','日常跟進');
                $arr['kehuziyuan']=$this->shuls($a,$records,'visit_type_name','客戶資源');
                $arr['dianhuashangmen']=$this->shuls($a,$records,'visit_type_name','電話上門');
                $arr['shouci']=$this->shuls($a,$records,'visit_obj_name','新開發');
                $arr['huifang']=$this->shuls($a,$records,'visit_obj_name','開發中客戶覆訪');
                ...
                $arr['jiuke']=$this->shuls($a,$records,'visit_obj_name','停單客戶回訪');
                ...
                $arr['dongbeicai']=$this->shuls($a,$records,'cust_type_name','PUB');
                $arr['kafeiting']=$this->shuls($a,$records,'cust_type_name','中餐');
                $arr['xiaochi']=$this->shuls($a,$records,'cust_type_name','咖啡餐廳');
                $arr['chuancai']=$this->shuls($a,$records,'cust_type_name','婚宴會館');
                $arr['riliao']=$this->shuls($a,$records,'cust_type_name','廠房餐廳');
                $arr['taiguocai']=$this->shuls($a,$records,'cust_type_name','日式');
                $arr['zejiangcai']=$this->shuls($a,$records,'cust_type_name','早餐');
                $arr['qingzhencai']=$this->shuls($a,$records,'cust_type_name','異國料理');
                $arr['huoguo']=$this->shuls($a,$records,'cust_type_name','火锅');
                $arr['saokao']=$this->shuls($a,$records,'cust_type_name','燒烤/炸物');
                ...
                $arr['yuenancai']=$this->shuls($a,$records,'cust_type_name','飲料店');
                $arr['mianbao']=$this->shuls($a,$records,'cust_type_name','蛋糕/麵包/甜點');
                ...
                $arr['xiezilou']=$this->shuls($a,$records,'cust_type_name','休閒娛樂');
                $arr['yiyuan']=$this->shuls($a,$records,'cust_type_name','公家機關');
                $arr['peixunjigou']=$this->shuls($a,$records,'cust_type_name','加油站');
                $arr['xuexiao']=$this->shuls($a,$records,'cust_type_name','商辦');
                $arr['gongcang']=$this->shuls($a,$records,'cust_type_name','工廠');
                $arr['yinglou']=$this->shuls($a,$records,'cust_type_name','家居/社區');
                $arr['yingyuan']=$this->shuls($a,$records,'cust_type_name','教育業');
                $arr['fangdican']=$this->shuls($a,$records,'cust_type_name','旅館業');
                $arr['shuiliao']=$this->shuls($a,$records,'cust_type_name','營造');
                $arr['youyong']=$this->shuls($a,$records,'cust_type_name','補教');
                $arr['wuye']=$this->shuls($a,$records,'cust_type_name','醫療');
...
//        print_r($model);
        if(!empty($model['all'])){
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('B'.$i2,'陌生開發') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('F'.$i2,'日常跟進') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('J'.$i2,'客戶資源') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('N'.$i2,'電話上門') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('B'.$i3,'新開發') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('N'.$i3,'開發中客戶覆訪') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('N'.$i4,'停單客戶回訪') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('F'.$i5,'日式') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('N'.$i5,'蛋糕/麵包/甜點') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('R'.$i5,'婚宴會館') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('B'.$i6,'中餐') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('F'.$i6,'早餐') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('R'.$i6,'廠房餐廳') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('V'.$i6,'燒烤/炸物') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('Z'.$i6,'飲料店') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('B'.$i7,'咖啡餐廳') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('F'.$i7,'異國料理') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('J'.$i8,'旅館業') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('Z'.$i8,'加油站') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('J'.$i9,'商辦') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('N'.$i9,'營造') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('Z'.$i9,'教育業') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('F'.$i10,'休閒娛樂') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('J'.$i10,'工廠') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('N'.$i10,'補教') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('V'.$i10,'醫療') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('F'.$i11,'公家機關') ;
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('J'.$i11,'家居/社區') ;
